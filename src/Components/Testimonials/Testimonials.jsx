        ...
        <ul ref={slider}>
            <li>
                <div className="slide">
                    ...
                    <p style={{ textAlign: 'justify', }}>Prof. Satyajit Chakrabarti, is a Professor, Technologist, Serial Entrepreneur and Venture Capitalist. He obtained his PhD in Nanotechnology from the National Institute of Technology and Masters in Computer Science from the University of British Columbia.<br/>
                                Prof. Chakrabarti manages companies in the field of Technology, Healthcare and Education. His Technology companies deliver products and services in the fields of Artificial Intelligence, Internet of Things, Virtual and Augmented Reality, Cybersecurity and Web Development. Prof. Chakrabarti is also an avid investor in early stage startups.<br/>
                                Prof. Chakrabarti is a passionate researcher with over 100 publications in the fields of Artificial Intelligence, IOT and Data Science and over 20 patents filed in various fields of Technology. He is a mentor and teacher to thousands of students across the globe. </p>
                </div>
            </li>
            <li>
                <div className="slide">
                    ...
                    <p style={{ textAlign: 'justify', }}>Dr. Amit Kumar Das has been working in the IT industry and in academic research / teaching in the area of Data Science for the past 25 years. He is currently working as Professor and Dean (Industry Consultancy) at the Institute of Engineering & Management and Chief Technology Officer at IEM Consultancy Services. Amit has done Ph.D. at University of Calcutta in the area of Machine Learning and M. Tech. from Birla Institute of Technology & Science, Pilani. <br/>
                    In the last role Amit was working as Principal Director, LTIMindtree working as the Competency Development Partner in the Digital Engineering Practice. In the past he has worked at Cognizant Technology Solutions for more than a decade and at Tata Consultancy Services. He has worked in diverse industry segments (e.g. Telecom, Financial Services, Insurance and Life Sciences) and different geographies within and outside India. He has also provided consulting in the area of Data Science with companies like Rebaca Technologies. </p>
                </div>
            </li>
            <li>
                <div className="slide">
